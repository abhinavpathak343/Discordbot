  ...
  return (
    <header className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-2 md:py-3">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-y-2 md:gap-y-0">
          ...
          <div className="flex items-center gap-x-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent truncate">
                qrshortner
              </h1>
              <p className="text-slate-300 text-sm font-medium truncate">Advanced URL shortner & QR Generator</p>
            </div>
          </div>
          {/* Right: Feature Highlights (all in one row) */}
          <div className="flex flex-wrap justify-end items-center gap-2 md:gap-3 w-full md:w-auto mt-2 md:mt-0">
